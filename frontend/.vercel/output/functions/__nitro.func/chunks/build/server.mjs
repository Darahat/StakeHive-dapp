import { hasInjectionContext, getCurrentInstance, inject, ref, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, provide, defineAsyncComponent, h, unref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { h as createError$1, k as klona, j as defuFn, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch$1, q as baseURL, r as createHooks, v as executeAsync, x as toRouteMatcher, y as createRouter$1, z as defu, A as destr, B as getRequestHeader, C as isEqual, D as setCookie, E as getCookie, F as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CRXMTOzx.mjs')
  },
  {
    name: "Explore",
    path: "/Explore",
    component: () => import('./index-DqM7FWS-.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-DnXC-Wmo.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CSZs6RU2.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C5gBC-My.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BwRdomqW.mjs'));
