...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.DGMzkd_E.mjs').then(interopDefault),
  ...
  "components/navigation.vue": () => import('./navigation-styles.BGODeGC1.mjs').then(interopDefault),
  "components/navigation.vue?vue&type=style&index=0&lang.css": () => import('./navigation-styles.BOLhiU-8.mjs').then(interopDefault)
};
